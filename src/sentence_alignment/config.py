...
def setup_laser():
    ...
    if os.path.exists(os.path.join(LASER_PATH, 'models')):
        print("""
            LASER/models dir found, skipping installation.
            Delete folders for and run script again for fresh installation'
        """)
    else:
    ...
    if os.path.exists(f'{os.path.join(LASER_PATH, "tools-external")}'):
        print("""
            LASER/tools-external dir found, skipping installation.
            Delete folders for and run script again for fresh installation
        """)
    else:
